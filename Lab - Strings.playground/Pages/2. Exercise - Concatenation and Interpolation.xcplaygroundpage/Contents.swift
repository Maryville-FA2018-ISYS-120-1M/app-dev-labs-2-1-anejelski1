...
let name = "Alex"
let age = 19
let sentence = "my name is " + name + " and after my next birthday i will be " + String(age + 1) + " years old."
//swift won't run this because it's "too complicated", so idk if it's right or not
