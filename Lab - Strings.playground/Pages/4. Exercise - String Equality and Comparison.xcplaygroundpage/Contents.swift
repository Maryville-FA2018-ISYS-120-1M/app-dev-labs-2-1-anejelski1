 ...
 */
if (namecaps.lowercased() == name.lowercased()){
    print(namecaps.lowercased() + " and " + name.lowercased() + " are equal")
}
else{
    print(namecaps.lowercased() + " and " + name.lowercased() + " are not equal")
}
/*:
...
if junior.contains("Jr")// i can't figure this error out and i've asked several people about it so i give up.   p.s. it still executes for some reason
{
